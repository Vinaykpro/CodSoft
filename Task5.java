...
public class Task5 {
    ...
    /*                              TASK 5
        ...
        availableCourses.add(new Course("Multivariable Calculus", "MATH301", "Dive into calculus with multiple variables. Study functions, limits, and derivatives in higher dimensions.", "Mondays and Wednesdays, 1:00 PM - 2:30 PM", 15, 5));
        availableCourses.add(new Course("World History: 20th Century", "HIST202", "Explore the significant events and social changes that shaped the 20th century on a global scale.", "Tuesdays and Fridays, 10:00 AM - 11:30 AM", 8, 1));
        availableCourses.add(new Course("Introduction to Physics", "PHYS101", "Delve into the basics of physics, covering mechanics, energy, and motion. No prior physics knowledge required.", "Thursdays, 9:00 AM - 12:00 PM", 25, 25));
        availableCourses.add(new Course("Conversational Mandarin", "LANG401", "Learn practical Mandarin Chinese for daily conversations. Emphasis on speaking and listening skills.", "Wednesdays and Fridays, 4:00 PM - 5:30 PM", 12, 8));
        availableCourses.add(new Course("Entrepreneurship Essentials", "BUSN202", "Uncover the key principles of starting and managing a successful business venture. Guest speakers and case studies included.", "Tuesdays, 2:00 PM - 4:00 PM", 20, 3));
                                
        System.out.println("\n\nStudent Registration:\n*********************");
        System.out.print("Enter Student Name:"); student.studentName = scanner.nextLine();
        System.out.print("Enter Student ID:"); student.studentID = scanner.nextLine();
        ...
        if(choice==1) {
            ...
            for(Course c : availableCourses) { c.showDetails(); }
        } else if(choice==4) {
